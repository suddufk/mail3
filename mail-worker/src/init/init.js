	...
	async v3_0DB(c) {
		try {
			await c.env.db.batch([
				c.env.db.prepare(`ALTER TABLE setting ADD COLUMN email_provider TEXT NOT NULL DEFAULT 'resend';`),
				c.env.db.prepare(`ALTER TABLE setting ADD COLUMN unosend_token TEXT NOT NULL DEFAULT '';`)
			]);
		} catch (e) {
